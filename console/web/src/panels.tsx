...
export function DetectionChannels({ channels, error, onChange, bare }: {
  channels: Channel[] | null; error: string | null; onChange: () => void; bare?: boolean;
}) {
  ...
  return (
    <Card title="Detection Channels" hint="pluggable registry (channels/*/manifest.json) — adding a channel is a folder, not a code change" bare={bare}>
      {error && <div className="err">{error}</div>}
        ...
        {sms && (
          <div className="channel-card wide">
            ...
            <div style={{ marginTop: 12 }}>
              ...
              {result && (
                <div className="ev compact" style={{ marginTop: 6 }}>
                  <div className="lead">
